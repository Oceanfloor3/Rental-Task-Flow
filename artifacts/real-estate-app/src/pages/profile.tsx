      ...
      <AnimatePresence mode="wait">
          ...
          <div className="space-y-5">
            ...
            <div className="bg-gradient-to-br from-[#0d1829] to-yellow-50 rounded-3xl border border-white/10 shadow-sm p-6 flex flex-col items-center gap-3">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-[#c9a020] font-medium mt-0.5">
                ...
                {avatarSeeds.map((seed) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && (
                        <div className="absolute inset-0 bg-[#c9a020]/10 flex items-end justify-center pb-1.5">
                          <div className="bg-[#c9a020] text-white text-[9px] font-bold px-2 py-0.5 rounded-full">
                            ✓
                          </div>
                        </div>
                      )}
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-[#c9a020] to-[#9a7a18] text-white py-6 h-auto rounded-2xl font-bold text-base disabled:opacity-40 shadow-lg shadow-[#c9a020]/20"
            >
        ...
        {view === "security" && renderSubView(
          <div className="bg-white rounded-2xl shadow-sm border border-white/10 p-5 space-y-4">
            ...
            <Button
              className="w-full bg-gradient-to-r from-[#c9a020] to-[#9a7a18] text-white py-6 h-auto rounded-xl font-semibold"
