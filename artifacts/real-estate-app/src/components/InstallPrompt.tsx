...
import { Share, Download, Home, TrendingUp, Wallet, CheckCircle2 } from "lucide-react";
            ...
            {platform === "ios" && (
              <>
                <div className="mb-5 bg-white/5 rounded-2xl p-4 border border-white/10">
                  ...
                  <div className="flex justify-center mb-4">
                    ...
                    >
                      ...
                      <span className="text-blue-400 text-[10px] font-semibold uppercase tracking-wide">Safari Share</span>
                    </motion.div>
                  </div>

                  <div className="flex flex-col gap-3">
                    {[
                      { step: "1", text: "Tap the Share button at the bottom of Safari", emoji: "📤", highlight: true },
                      { step: "2", text: 'Scroll and tap "Add to Home Screen"', emoji: "➕", highlight: false },
                      { step: "3", text: 'Tap "Add" in the top-right corner', emoji: "✅", highlight: false },
                    ].map(({ step, text, emoji, highlight }) => (
                      <div key={step} className={`flex items-center gap-3 rounded-xl px-3 py-2.5 ${highlight ? "bg-blue-500/15 border border-blue-500/30" : "bg-white/5"}`}>
                ...
                <button
                  ...
                  className="w-full bg-amber-600 hover:bg-amber-500 active:scale-95 text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-2.5 transition-all mb-3 text-base shadow-lg shadow-amber-900/40"
                >
